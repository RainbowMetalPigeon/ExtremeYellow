...
_SeviiFourIslandCitySignText3::
	text "PINK's house"
	done

_SeviiFourIslandCitySignText4::
	text "ICEFALL CAVE"
	done
...
_SeviiIslandsDockTruckMessage_Four_Braille::
	text "%3 W, %3 S"
;	xxxx "123456789012345678"
	done
