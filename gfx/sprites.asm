...
; new sprites -----------
DarkGuideSprite::        INCBIN "gfx/sprites/darkguide.2bpp"
FrenchOrangeSprite::     INCBIN "gfx/sprites/frenchorange.2bpp"
CramorantSprite::        INCBIN "gfx/sprites/cramorant.2bpp"
MordSprite::             INCBIN "gfx/sprites/mord.2bpp"
CarrotSprite::           INCBIN "gfx/sprites/carrot.2bpp"
...
TravelerSprite::         INCBIN "gfx/sprites/traveler.2bpp"
FlyingPikachuSprite::    INCBIN "gfx/sprites/flyingpikachu.2bpp"
CrashingPikachuSprite::  INCBIN "gfx/sprites/crashingpikachu.2bpp"
ScientistFSprite::       INCBIN "gfx/sprites/scientistf.2bpp"
SlowkingSprite::         INCBIN "gfx/sprites/slowking.2bpp"
Amber2Sprite::           INCBIN "gfx/sprites/amber2.2bpp"
MissingNoSprite::        INCBIN "gfx/sprites/missingno_ow.2bpp"
GlitchyPlayerSprite::    INCBIN "gfx/sprites/glitchyplayer.2bpp"
TransparentSprite::      INCBIN "gfx/sprites/transparent.2bpp"
TrophyLeagueSprite::     INCBIN "gfx/sprites/trophy_league.2bpp"
TrophyInverseSprite::    INCBIN "gfx/sprites/trophy_inverse.2bpp"
TrophyMegaSprite::       INCBIN "gfx/sprites/trophy_mega.2bpp"
TrophyPokedexSprite::    INCBIN "gfx/sprites/trophy_pokedex.2bpp"
TrophyMerchantSprite::   INCBIN "gfx/sprites/trophy_merchant.2bpp"
TrophyBFSprite::         INCBIN "gfx/sprites/trophy_bf.2bpp"
...
ErikaGLSprite::          INCBIN "gfx/sprites/erikagl.2bpp"
KogaGLSprite::           INCBIN "gfx/sprites/kogagl.2bpp"
