...
; new effects -------------------------------
	...
	const SANDSTORM_EFFECT
	const HAIL_EFFECT

	const GRASSY_TERRAIN_EFFECT
	const ELECTRIC_TERRAIN_EFFECT
	const MISTY_TERRAIN_EFFECT
	const PSYCHIC_TERRAIN_EFFECT

	const TRICK_ROOM_EFFECT
