...
; trainer dvs
DEF ATKDEFDV_TRAINER EQU $FF	; new, maxed to FF = 15-15 (first bit first stat, second bit second stat)
DEF SPDSPCDV_TRAINER EQU $FF	; new, maxed to FF = 15-15 (first bit first stat, second bit second stat)
