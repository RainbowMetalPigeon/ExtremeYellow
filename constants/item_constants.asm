...
DEF SAFARI_ROCK EQU $16 ; overload
	...
	const CC_INVITE     ; new
	const FLAME_PLUME   ; new
	const ROOM_KEY_34   ; new
...
; new ----- I guess I can treat the special-dialogue "items" as "floors"
	...
	const DARKGUIDE_HINT_9
	const DARKGUIDE_HINT_10
	const DARKGUIDE_HINT_11
	const DARKGUIDE_HINT_12
...
DEF TM01 EQU const_value
	add_tm MEGA_PUNCH   ; $C9 = TM01 - ground item: MtMoonB2F
	...
	add_tm X_SCISSOR    ; $F4 = TM44 - ground item: SSAnneB1FRooms
