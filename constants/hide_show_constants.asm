...
; new ; this block now corresponds to MissableObjectsExtra
	...
	const HS_LUNAR_SHRINE_TOURIST_1        ; new, secretly part of CELADON_CHIEF_HOUSE
	...
	const HS_FUCHSIA_MEETING_ROOM_AFTER_2  ; new
	const HS_FUCHSIA_MEETING_ROOM_AFTER_3  ; new
	const HS_FUCHSIA_MEETING_ROOM_BEFORE_1 ; new
	const HS_FUCHSIA_MEETING_ROOM_BEFORE_2 ; new
	const HS_FUCHSIA_MEETING_ROOM_BEFORE_3 ; new
	...
	const HS_HAUNTED_ISLAND_OF_NUMBERS_MISSINGNO ; new
	const HS_HAUNTED_HOUSE_4_MOM_SW ; new
	const HS_HAUNTED_HOUSE_4_MOM_SE ; new
	const HS_HAUNTED_HOUSE_4_MOM_NE ; new
	const HS_HAUNTED_HOUSE_4_MOM_NW ; new
	const HS_HAUNTED_HOUSE_4_MOM_TORNADO_UP ; new
	...
	const HS_CELADON_HOTEL_ROOMS_TROPHY_1 ; new
	const HS_CELADON_HOTEL_ROOMS_TROPHY_2 ; new
	const HS_CELADON_HOTEL_ROOMS_TROPHY_3 ; new
	const HS_CELADON_HOTEL_ROOMS_TROPHY_4 ; new
	const HS_CELADON_HOTEL_ROOMS_TROPHY_5 ; new
