...
; SetPalFunctions indexes (see engine/gfx/palettes.asm)
	...
	const SET_PAL_TRAINER_CARD_BACK    ; new
...
; SuperPalettes indexes (see data/sgb/sgb_palettes.asm)
	...
	const PAL_MELMETAL   ; new
	const PAL_THUFIZER   ; new
	const PAL_PORYMON	 ; new
	const PAL_MZYGARDE   ; new
	...
	const PAL_MELMETALSHINY   ; new
	const PAL_THUFIZERSHINY   ; new
	const PAL_MZYGARDESHINY ; new
...
; copies of kanto stuff
	...
	const PAL_SEVII_MELMETAL
	const PAL_SEVII_THUFIZER
	const PAL_SEVII_PORYMON
	const PAL_SEVII_MZYGARDE
	...
	const PAL_SEVII_MELMETALSHINY
	const PAL_SEVII_THUFIZERSHINY
	const PAL_SEVII_MZYGARDESHINY
