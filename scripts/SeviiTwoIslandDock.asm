SeviiTwoIslandDock_Script:
	RPTextChooser SeviiTwoIslandDock_TextPointers, SeviiTwoIslandDock_TextPointers_Rocket
...
SeviiTwoIslandDock_TextPointers_Rocket:
	dw SeviiTwoIslandDockSpriteText1_RP
	dw SeviiTwoIslandDockBgText1
	dw SeviiTwoIslandDockBgText2
	dw SeviiTwoIslandDockBgText3
...
SeviiTwoIslandDockSpriteText1:
	text_asm
; print intro
	ld hl, SeviiTwoIslandDockSailorText_PleaseGetOnThePier
...
SeviiTwoIslandDockBgText3:
	text_asm
	ld hl, SeviiIslandsDockTruckMessage_Two
	call PrintText
	ld hl, SeviiIslandsDockEmptykMessage_Two
	call PrintText
	callfar LoadFontTilePatternsBraille
	ld hl, SeviiIslandsDockTruckMessage_Two_Braille
	call PrintText
	jp TextScriptEnd

SeviiIslandsDockTruckMessage_Two_Braille:
	text_far _SeviiIslandsDockTruckMessage_Two_Braille
	text_end

SeviiIslandsDockEmptykMessage_Two:
	text_far _SeviiIslandsDockEmptykMessage
	text_end

SeviiIslandsDockTruckMessage_Two:
...
SeviiTwoIslandDockSailorText_PleaseGetOnThePier:
	text_far _SeviiIslandsDockSailorText_PleaseGetOnThePier
	text_end

; new for RP ===================================

SeviiTwoIslandDockSpriteText1_RP:
	text_asm
; print intro
	ld hl, SeviiTwoIslandDockSailorText_PleaseGetOnThePier_RP
	ld a, [wSpritePlayerStateData1FacingDirection]
	cp SPRITE_FACING_DOWN
	jr nz, .printAndEnd
; right direction
	ld hl, SeviiTwoIslandDockSailorText_Intro_RP
	call PrintText
; print the list of destinations
	xor a
	ld [wCurrentMenuItem], a
...
; we chose a destination
	ld a, [wcf91]
	ld [wUniQuizAnswer], a
	ld hl, SeviiTwoIslandDockSailorText_LetsGo_RP
	call PrintText
	ld a, 1
	ld [wCurMapScript], a
	jp TextScriptEnd
...
.exit
	xor a
	ld [wListScrollOffset], a
	ld hl, SeviiTwoIslandDockSailorText_Canceled_RP
.printAndEnd
	call PrintText
	jp TextScriptEnd

SeviiTwoIslandDockSailorText_Intro_RP:
	text_far _SeviiIslandsDockSailorText_Intro_RP
	text_end

SeviiTwoIslandDockSailorText_LetsGo_RP:
	text_far _SeviiIslandsDockSailorText_LetsGo_RP
	text_end

SeviiTwoIslandDockSailorText_Canceled_RP:
	text_far _SeviiIslandsDockSailorText_Canceled_RP
	text_end

SeviiTwoIslandDockSailorText_PleaseGetOnThePier_RP:
