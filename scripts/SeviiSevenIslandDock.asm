...
SeviiSevenIslandDock_ScriptPointers:
	...
	dw SeviiSevenIslandDockScritp_TurnSailorAndMovePlayerScript
	dw SeviiSevenIslandDockScritp_FerryWarpScript
	dw SeviiSevenIslandDockScritp_PostPlayerMovementAndShowSailors
...
SeviiSevenIslandDockScritp_TurnSailorAndMovePlayerScript:
; turn sailor
	ld a, 1
	ldh [hSpriteIndex], a
	lb bc, STAY, DOWN
...
SeviiSevenIslandDockScritp_PostPlayerMovementAndShowSailors:
; wait for player to have moved
	ld a, [wSimulatedJoypadStatesIndex]
	and a
	ret nz
