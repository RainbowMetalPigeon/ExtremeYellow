SeviiOneIslandGym2_Script:
	RPTextChooser SeviiOneIslandGym2_TextPointers, SeviiOneIslandGym2_TextPointers_Rocket
...
SeviiOneIslandGym2_TextPointers_Rocket:
	dw SeviiOneIslandGym2Text1 ; TBE
