...
; 2-island
	...
	db HS_SEVII_ROUTE_33_ROCK_2
 	db HS_SEVII_TWO_ISLET_ROCK_1
 	db HS_SEVII_TWO_ISLET_ROCK_2
 	db HS_SEVII_TWO_ISLET_ROCK_3
 	db HS_SEVII_TWO_ISLET_ROCK_4
 	db HS_SEVII_TWO_ISLET_ROCK_5
; 3-island
; 4-island
...
LoadSurfingPlayerSpriteGraphics2_::
	...
	jr z, .asm_0d75
	dec a
	jr z, LoadSurfingPlayerSpriteGraphics_
	dec a
	jr z, .asm_0d7c
.asm_0d75
	ld a, [wd472]
