...
.focusEnergyUsed
;	srl b									; new - try to fix focus energy
	sla b									; new - try to fix focus energy
	jr nc, .continueWithFocusEnergyUsed		; new - try to fix focus energy
	ld b, $ff								; new - try to fix focus energy
	jr .noFocusEnergyUsed					; new - try to fix focus energy
.continueWithFocusEnergyUsed				; new - try to fix focus energy
	sla b									; new - try to fix focus energy
	jr nc, .noFocusEnergyUsed				; new - try to fix focus energy
	ld b, $ff								; new - try to fix focus energy
.noFocusEnergyUsed
