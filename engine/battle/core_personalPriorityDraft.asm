...
;	jp .playerMovesFirst ; if player used Quick Attack and enemy didn't
	jr z, .playerUsedPriorityMove	; edits for priority moves start here
	cp BULLET_PUNCH
	jr z, .playerUsedPriorityMove
	jp .playerDidNotUsePriorityMove
.playerUsedPriorityMove
	ld a, [wEnemySelectedMove]
	cp QUICK_ATTACK
	jr z, .compareSpeed		; both used a priority move
	cp BULLET_PUNCH
	jr z, .compareSpeed		; both used a priority move
...
.playerDidNotUsePriorityMove
	...
	cp BULLET_PUNCH			; added
	jr z, .enemyMovesFirst	; added
