...
; get the screen coordinates of the sprite the bubble is to be displayed above
	...
	lb bc, $3c, $58 ; Y-X if birb is RIGHT of player
	cp SPRITE_FACING_RIGHT
	jr z, .coordinatesFound

	lb bc, $4c, $48 ; Y-X if birb is DOWN of player
	cp SPRITE_FACING_DOWN
	jr z, .coordinatesFound

	lb bc, $2c, $48 ; Y-X if birb is UP of player
	cp SPRITE_FACING_UP
	jr z, .coordinatesFound

;	cp SPRITE_FACING_LEFT
	lb bc, $3c, $38 ; Y-X if birb is LEFT of player
