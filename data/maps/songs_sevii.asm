...
; 3-island
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone)       ; SEVII_ROUTE_33_DIVE
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone)       ; SEVII_ROUTE_33_DIVE_CAVERN_F1
...
; 4-island
	...
	db MUSIC_GAME_CORNER, BANK(Music_GameCorner)       ; SEVII_FOUR_ISLAND_PARKOUR_UNDERGROUND
...
; 6-island
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone)       ; SEVII_SECRET_BEACH_DIVE
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown)       ; SEVII_SECRET_BEACH_HOUSE
