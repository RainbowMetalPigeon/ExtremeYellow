...
; 7-island
	...
	dw NoHSSevii ; SEVII_SEVEN_ISLAND_GYM_2
	dw NoHSSevii ; SEVII_SEVEN_ISLAND_GYM_2_DIVE
	dw NoHSSevii ; SEVII_SEVEN_ISLAND_GYM_2_DIVE_CAVERN
	dw NoHSSevii ; SEVII_SEVEN_ISLAND_GYM_3
...
SeviiThreeIslandCityHS:
	db SEVII_THREE_ISLAND_CITY, 10, SHOW
	db SEVII_THREE_ISLAND_CITY, 11, SHOW
