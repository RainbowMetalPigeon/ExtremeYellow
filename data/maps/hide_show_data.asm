...
; entries correspond to map ids
	...
	dw VictoryRoad1FHS
	dw SecludedAtollNWHS ; SECLUDED_ATOLL_NW
...
PalletTownHS:
	...
	db PALLET_TOWN, $04, HIDE ; Dark Guide
ViridianCityHS:
...
ViridianForestHS: ; edited because of rematch Erika
	...
	db VIRIDIAN_FOREST, 10, SHOW
	db VIRIDIAN_FOREST, 12, SHOW ; new, rock
MtMoon1FHS:
...
PokemonMansionB1FHS:
	db POKEMON_MANSION_B1F,  4, SHOW
	db POKEMON_MANSION_B1F,  5, SHOW
	db POKEMON_MANSION_B1F,  6, SHOW
	db POKEMON_MANSION_B1F,  7, SHOW
	db POKEMON_MANSION_B1F,  9, SHOW
	db POKEMON_MANSION_B1F, 10, SHOW ; new, rival
SafariZoneEastHS:
...
SecludedAtollNWHS:
	db SECLUDED_ATOLL_NW, $01, SHOW ; rock
ChampionsRoomHS:
