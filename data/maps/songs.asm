MapSongBanks::
	...
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; HAUNTED_REDS_HOUSE, new
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE_2_TRADE_HOUSE
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE_2_ALL_GATES
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; HAUNTED_PALLET_TOWN, new
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; ROUTE_21_DIVE, new
	...
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; SUNKEN_SHIP_1F, new
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; PIKACHU_GROTTO, new
	...
	db MUSIC_CITIES1, BANK(Music_Cities1) ; SAFFRON_CLIMB_CLUB ; new
	...
	db MUSIC_GYM, BANK(Music_Gym) ; OCHRE_GYM
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; OCHRE_WONDERLAND
	db MUSIC_SS_ANNE, BANK(Music_SSAnne) ; OCHRE_RESEARCH_CENTER_1, TBE?
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_1F
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SECLUDED_ATOLL_NW
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SECLUDED_ATOLL_NE
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SECLUDED_ATOLL_SE
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SECLUDED_ATOLL_SW
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; LANCES_ROOM
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; OBSIDIAN_WOOD, new
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; OBSIDIAN_WAREHOUSE, new
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; OBSIDIAN_WAREHOUSE_FINAL, new
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; OBSIDIAN_MINES, new
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; ROUTE_19_DIVE
	...
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; LAVENDER_HOUSES, edited, merge of all Lavender houses
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; HAUNTED_HOUSE_2, new
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; HAUNTED_HOUSE_3, new
	db MUSIC_SS_ANNE, BANK(Music_SSAnne) ; OCHRE_RESEARCH_CENTER_2, TBE?
	...
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; HAUNTED_HOUSE_4, new
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; ROUTE_20_DIVE
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; ROUTE_19_DIVE_CAVERN
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; ROUTE_21_DIVE_CAVERN
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; CINNABAR_POKECENTER
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; HAUNTED_ISLAND_OF_NUMBERS, TBE
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SAFARI_ZONE_EXTRA ; new
	db MUSIC_CELADON, BANK(Music_Celadon) ; CELADON_HOTEL_HALL, new
	...
	db MUSIC_GAME_CORNER, BANK(Music_GameCorner) ; FORLORN_VALLEY ; new, TBV
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE_16_GATE_1F
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; SUNKEN_SHIP_ROOMS, new
	...
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; ROUTE_22_GATE ; edited
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_2F
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE_12_GATE_2F
	db MUSIC_CELADON, BANK(Music_Celadon) ; CELADON_HOTEL_ROOMS, new
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; OCHRE_REHABILITATION_CENTER, new
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; OCHRE_POKECENTER, new
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; OBSIDIAN_POKECENTER, new
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SAFARI_ZONE_QUADRUPLE_REST_HOUSE, new
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SAFARI_ZONE_SECRET_HOUSE
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; HAUNTED_HOUSE_1, new
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; UNUSED
...
;	db MUSIC_LAVENDER, BANK(Music_Lavender) ; NAME_RATERS_HOUSE ; removed
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; CINNABAR_VOLCANO, new
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; CINNABAR_VOLCANO_BF, new
	db MUSIC_CELADON, BANK(Music_Celadon) ; TRADE_CENTER
	db MUSIC_CELADON, BANK(Music_Celadon) ; COLOSSEUM
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CERULEAN_CAVE_EXTRA_TOP
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CERULEAN_CAVE_EXTRA_MIDDLE
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CERULEAN_CAVE_EXTRA_BOTTOM
	db MUSIC_YELLOW_UNUSED_SONG, BANK(Music_YellowUnusedSong) ; CERULEAN_CAVE_EXTRA_FINAL, with the unused song there's no sound for boulder-strength nor tree-cut
