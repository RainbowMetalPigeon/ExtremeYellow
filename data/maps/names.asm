...
Route32DiveName:     db "SUB ROUTE 32@"
...
FiveIslandWarehouseName: db "CHRONO WAREHOUSE@"
ThreeIslandCavesName: db "FAMILY CAVES@"
BerryForestName:     db "DREAM FOREST@"
...
TwoIsletName:             db "BOON ISLET@"
TwoIsletDiveName:         db "SUB BOON ISLET@"
TwoIsletRockMazeName:     db "ROCK MAZE@"
TwoIsletRockMazeDiveName: db "SUB ROCK MAZE@"

OneUndergroundName:       db "KNOT UNDERGRO.@"
TwoUndergroundName:       db "BOON UNDERGRO.@"
ThreeUndergroundName:     db "FAMILY UNDERGRO.@"
FourUndergroundName:      db "FLOE UNDERGRO.@"
