MapSpriteSets:
	...
	db $0e ; ELECTRIC_RAVINE, new (same set as Viridian City, i.e. south of Route2)
...
; sprite set $01
	...
	db SPRITE_GAMBLER
	db SPRITE_OAK
	db SPRITE_MONSTER ; edited, was SWIMMER
	db SPRITE_POKE_BALL
...
; sprite set $02
	...
	db SPRITE_YOUNGSTER
	db SPRITE_MONSTER
	db SPRITE_BIKER ; edited, was SPRITE_SUPER_NERD
	db SPRITE_HIKER
	db SPRITE_TRAVELER
...
; sprite set $05
	...
	db SPRITE_GIRL
	db SPRITE_SUPER_NERD ; edited, was fisher
...
; sprite set $08
	...
	db SPRITE_PIKACHU
	db SPRITE_BIKER
	db SPRITE_BLUE ; edited, was SPRITE_SUPER_NERD
...
; sprite set $16, for Lake of Mist
	table_width 1
	db SPRITE_PIKACHU
	db SPRITE_FISHER
	db SPRITE_CHANNELER
