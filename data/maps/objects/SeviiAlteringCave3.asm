...
;	bg_event 11, 11, 5 ; Route2Text4
	...
	def_object_events
	object_event  6, 29, SPRITE_ROCKSMASHABLE_ROCK, STAY, ROCKSMASHABLE_ROCK_MOVEMENT_BYTE_2, 1
	...
	object_event 14, 19, SPRITE_ROCKSMASHABLE_ROCK, STAY, ROCKSMASHABLE_ROCK_MOVEMENT_BYTE_2, 6
