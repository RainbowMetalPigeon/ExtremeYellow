VermilionCity_Object:
	...
	def_bg_events
	bg_event 17,  5, 10 ; VermilionCityText8 ; moved to the left
	bg_event 37, 13, 11 ; VermilionCityText9
	bg_event 22, 13, 12 ; MartSignText ; moved to the left
	bg_event 12,  3, 13 ; PokeCenterSignText
	bg_event  7, 13, 14 ; VermilionCityText12
	bg_event  7, 19, 15 ; VermilionCityText13
	bg_event 29, 15, 16 ; VermilionCityText14
	bg_event 31,  9, 17 ; VermilionCityText16 ; new, Battle Facility
