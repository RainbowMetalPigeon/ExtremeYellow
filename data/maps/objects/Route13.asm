Route13_Object:
	...
	object_event 48, 10, SPRITE_COOLTRAINER_F, STAY, DOWN, 2, OPP_JR_TRAINER, 12
	object_event 27,  9, SPRITE_COOLTRAINER_F, STAY, DOWN, 3, OPP_JR_TRAINER, 13
	object_event 23, 10, SPRITE_COOLTRAINER_F, STAY, LEFT, 4, OPP_JR_TRAINER, 14
	object_event 50,  5, SPRITE_COOLTRAINER_F, STAY, DOWN, 5, OPP_JR_TRAINER, 15
