CeladonGym_Object:
	...
	object_event  5,  3, SPRITE_COOLTRAINER_F, STAY, DOWN, 8, OPP_COOLTRAINER, 63 ; edited
	object_event  4,  6, SPRITE_COOLTRAINER_F, STAY, UP, 9, OPP_COOLTRAINER, 25 ; new
	object_event  7, 15, SPRITE_GYM_GUIDE, STAY, DOWN, 10 ; new
