VictoryRoad3F_Object:
	...
	def_object_events
	object_event 28,  5, SPRITE_COOLTRAINER_F, STAY, LEFT, 1, OPP_COOLTRAINER, 15
	object_event  7, 13, SPRITE_COOLTRAINER_F, STAY, RIGHT, 2, OPP_COOLTRAINER, 2
	object_event  6, 14, SPRITE_COOLTRAINER_F, STAY, LEFT, 3, OPP_COOLTRAINER, 16
	object_event 13,  3, SPRITE_COOLTRAINER_F, STAY, RIGHT, 4, OPP_COOLTRAINER, 3
