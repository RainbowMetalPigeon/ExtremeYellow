SeviiRoute38Houses_Object:
	...
	def_bg_events
	bg_event  2,  0,  5 ; SeviiRoute38HousesSignText1
	bg_event  3,  0,  6 ; SeviiRoute38HousesSignText2
	bg_event  3,  4,  7 ; SeviiRoute38HousesSignText3
	...
	object_event 18,  3, SPRITE_CLIPBOARD, STAY, NONE, 4
