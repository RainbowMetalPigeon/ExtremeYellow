RockTunnel1F_Object:
	...
	warp_event 23, 15, ROUTE_10, 5 ; new
	warp_event 23, 29, ROCK_TUNNEL_B1F, 5 ; new
	...
	object_event 37, 21, SPRITE_COOLTRAINER_F, STAY, LEFT, 5, OPP_JR_TRAINER, 17
	object_event 22, 24, SPRITE_COOLTRAINER_F, STAY, DOWN, 6, OPP_JR_TRAINER, 18
	object_event 32, 24, SPRITE_COOLTRAINER_F, STAY, RIGHT, 7, OPP_JR_TRAINER, 19
