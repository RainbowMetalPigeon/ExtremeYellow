...
;	bg_event  5, 65, 4 ; Route2Text3
	...
	; non-persons
	object_event  8, 48, SPRITE_ROCKSMASHABLE_ROCK, STAY, ROCKSMASHABLE_ROCK_MOVEMENT_BYTE_2, 11
	object_event 23, 56, SPRITE_POKE_BALL, STAY, NONE, 12, RARE_CANDY
	object_event 14, 23, SPRITE_POKE_BALL, STAY, NONE, 13, NUGGET
	object_event 13, 40, SPRITE_COOLTRAINER_F, STAY, DOWN, 14
