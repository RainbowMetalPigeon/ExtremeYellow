SeviiFiveIslandPokemonCenterAndMart_Object:
	db $0 ; border block

	def_warp_events
	warp_event  3,  7, SEVII_FIVE_ISLAND_CITY, 3
	warp_event  4,  7, SEVII_FIVE_ISLAND_CITY, 3
	warp_event 17,  7, SEVII_FIVE_ISLAND_CITY, 4
	warp_event 18,  7, SEVII_FIVE_ISLAND_CITY, 4
	...
	object_event  1,  5, SPRITE_ERIKA, WALK, ANY_DIR, 3
