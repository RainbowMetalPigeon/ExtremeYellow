SeviiRoute39Dive_Object:
	db $08 ; border block

	def_warp_events
;	warp_event 10, 23, SEVII_ROUTE_39_DIVE_CAVERN, 1
...
;	object_event 36, 39, SPRITE_POKE_BALL, STAY, NONE, 5, PROTEIN
;	object_event 36, 39, SPRITE_POKE_BALL, STAY, NONE, 6, IRON
;	object_event 37, 39, SPRITE_POKE_BALL, STAY, NONE, 7, CALCIUM
;	object_event 37, 39, SPRITE_POKE_BALL, STAY, NONE, 8, CARBOS

	def_warps_to SEVII_ROUTE_39_DIVE
