...
;	bg_event  5, 65, 4 ; Route2Text3
	...
	object_event 30, 18, SPRITE_COOLTRAINER_M, STAY, LEFT, 8, OPP_TAMER, 7
	...
	; non-persons
	object_event  3, 18, SPRITE_ROCKSMASHABLE_ROCK, STAY, NONE, 12
	object_event 35, 13, SPRITE_POKE_BALL, STAY, NONE, 13, RARE_CANDY
	object_event  3, 21, SPRITE_SIRD, STAY, UP, 14
