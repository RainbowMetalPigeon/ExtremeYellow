VictoryRoad1F_Object:
	...
	object_event 11,  0, SPRITE_POKE_BALL, STAY, NONE, 4, TM_GUNK_SHOT
	object_event  9,  2, SPRITE_POKE_BALL, STAY, NONE, 5, RARE_CANDY
	object_event  5, 15, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, 6 ; person
	object_event 14,  2, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, 7 ; person
	object_event  2, 10, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, 8 ; person
