VictoryRoad1F_Object:
	...
	def_object_events
	object_event  7,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, 1, OPP_COOLTRAINER, 5 ; pseudo-green
	object_event  3,  2, SPRITE_COOLTRAINER_F, STAY, DOWN, 2, OPP_COOLTRAINER, 18 ; pseudo-red
	object_event 14,  0, SPRITE_FISHING_GURU, STAY, RIGHT, 3, OPP_FISHER, 12 ; pseudo-yellow
	object_event  0, 13, SPRITE_COOLTRAINER_F, STAY, RIGHT, 4, OPP_COOLTRAINER, 24 ; pseudo-blue
