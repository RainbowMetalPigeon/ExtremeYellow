VictoryRoad1F_Object:
	...
	def_object_events
	object_event  7,  5, SPRITE_GREEN, STAY, RIGHT, 1, OPP_COOLTRAINER, 5 ; pseudo-green
	object_event  3,  2, SPRITE_RED, STAY, DOWN, 2, OPP_COOLTRAINER, 18 ; pseudo-red
	object_event 14,  0, SPRITE_YELLOW, STAY, RIGHT, 3, OPP_COOLTRAINER, 29 ; pseudo-yellow
	object_event  0, 13, SPRITE_BLUE, STAY, RIGHT, 4, OPP_COOLTRAINER, 24 ; pseudo-blue
