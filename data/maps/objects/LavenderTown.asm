LavenderTown_Object:
	...
	warp_event 13, 13, LAVENDER_POKECENTER, 3 ; edited due to MERGING
	warp_event  3, 13, LAVENDER_HOUSES, 3 ; edited due to MERGING
	warp_event  7, 13, LAVENDER_HOUSES, 5 ; edited due to MERGING
	warp_event 17, 14, LAVENDER_HOUSES, 7 ; new, gate
	warp_event 17, 15, LAVENDER_HOUSES, 8 ; new, gate

	def_bg_events
	bg_event 11,  9, 5 ; LavenderTownText4
	bg_event  9,  3, 6 ; LavenderTownText5
	bg_event 14, 13, 7 ; MartSignText
