SeviiSevenIslandGym2_Object:
	...
	; rocks
	object_event 29, 16, SPRITE_ROCKSMASHABLE_ROCK, STAY, ROCKSMASHABLE_ROCK_MOVEMENT_BYTE_2, 8
	object_event 23, 19, SPRITE_ROCKSMASHABLE_ROCK, STAY, ROCKSMASHABLE_ROCK_MOVEMENT_BYTE_2, 9
	; items
