Route29_Object:
	...
	def_object_events
	object_event 17,  9, SPRITE_COOLTRAINER_F, STAY, DOWN, 1, OPP_COOLTRAINER, 74 ; edited
	object_event  9, 16, SPRITE_COOLTRAINER_F, STAY, LEFT, 2, OPP_COOLTRAINER, 75 ; edited
	object_event 22, 42, SPRITE_COOLTRAINER_F, STAY, RIGHT, 3, OPP_COOLTRAINER, 76 ; edited
