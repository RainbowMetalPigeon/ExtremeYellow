Route15_Object:
	...
	def_object_events
	object_event 41, 11, SPRITE_COOLTRAINER_F, STAY, DOWN, 1, OPP_JR_TRAINER, 20
	object_event 53, 10, SPRITE_COOLTRAINER_F, STAY, LEFT, 2, OPP_JR_TRAINER, 21
	...
	object_event 37,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, 9, OPP_JR_TRAINER, 22
	object_event 18, 13, SPRITE_COOLTRAINER_F, STAY, UP, 10, OPP_JR_TRAINER, 23
	object_event 18,  5, SPRITE_POKE_BALL, STAY, NONE, 11, TM_FEINT_ATTACK
