...
;	bg_event 11, 11, 5 ; Route2Text4
	...
	object_event 14, 19, SPRITE_ROCKSMASHABLE_ROCK, STAY, ROCKSMASHABLE_ROCK_MOVEMENT_BYTE_2, 4
	...
	object_event 14, 19, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, 8
