ViridianGym_Object:
	...
	object_event 10, 11, SPRITE_HIKER, STAY, UP, 2, OPP_BLACKBELT, 6
	object_event 11,  7, SPRITE_ROCKER, STAY, DOWN, 3, OPP_TAMER, 3
	object_event  0, 17, SPRITE_HIKER, STAY, RIGHT, 4, OPP_BLACKBELT, 7
	...
	object_event  6,  6, SPRITE_COOLTRAINER_F, STAY, DOWN, 8, OPP_COOLTRAINER, 60 ; edited
