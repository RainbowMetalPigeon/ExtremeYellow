ViridianGym_Object:
	...
	object_event 12,  7, SPRITE_COOLTRAINER_F, STAY, DOWN, 2, OPP_COOLTRAINER, 61 ; edited
	...
	object_event 13,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, 6, OPP_COOLTRAINER, 62 ; edited
	object_event 10,  1, SPRITE_HIKER, STAY, DOWN, 7, OPP_BLACKBELT, 8
	object_event  2, 16, SPRITE_ROCKER, STAY, RIGHT, 8, OPP_TAMER, 4
	object_event  6,  5, SPRITE_COOLTRAINER_F, STAY, DOWN, 9, OPP_COOLTRAINER, 60 ; edited
	object_event  1,  4, SPRITE_COOLTRAINER_F, STAY, RIGHT, 10, OPP_COOLTRAINER, 59 ; new
