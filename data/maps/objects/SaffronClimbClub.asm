SaffronClimbClub_Object:
	...
	def_object_events
	object_event  8, 17, SPRITE_GYM_GUIDE, STAY, DOWN, 1
	...
	object_event  5,  9, SPRITE_POKE_BALL, STAY, NONE, 6, SUPER_POTION
	object_event 13,  8, SPRITE_POKE_BALL, STAY, NONE, 7, ULTRA_BALL
	object_event 27,  4, SPRITE_POKE_BALL, STAY, NONE, 8, REVIVE
