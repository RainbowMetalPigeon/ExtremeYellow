...
;	add_tx_pre Route15UpstairsBinocularsText         ; 0A
	...
	add_tx_pre OchrePokecenterBenchGuyText           ; 1D, new
	add_tx_pre ObsidianPokecenterBenchGuyText        ; 20, new
...
;	add_tx_pre VermilionGymTrashSuccessText2         ; 3E XXX unused
	...
	add_tx_pre SeviiTanobyGardenHiddenTextMew5       ; new
	add_tx_pre SeviiTanobyGardenHiddenTextMew6       ; new
	...
	add_tx_pre SeviiGyms_SageRefusedYourEntryText_RP ; new
