...
TypeEffects_TCG:
	...
	db TCG_FIGHTING,	TCG_LIGHTNING,		SUPER_EFFECTIVE
	db TCG_FIGHTING,	TCG_COLORLESS,		SUPER_EFFECTIVE
	db TCG_FIGHTING,	TCG_DARK,			SUPER_EFFECTIVE
	db TCG_FIGHTING,	TCG_PSYCHIC,		NOT_VERY_EFFECTIVE
	db TCG_FIGHTING,	TCG_DRAGON,			NOT_VERY_EFFECTIVE

	db TCG_METAL,		TCG_WATER,			SUPER_EFFECTIVE
	db TCG_METAL,		TCG_PSYCHIC,		SUPER_EFFECTIVE ; ?
	db TCG_METAL,		TCG_LIGHTNING,		NOT_VERY_EFFECTIVE

	db TCG_FIRE,		TCG_GRASS,			SUPER_EFFECTIVE
	db TCG_FIRE,		TCG_METAL,			SUPER_EFFECTIVE
	db TCG_FIRE,		TCG_WATER,			NOT_VERY_EFFECTIVE ; ?
	db TCG_FIRE,		TCG_DRAGON,			NOT_VERY_EFFECTIVE

	db TCG_WATER,		TCG_FIRE,			SUPER_EFFECTIVE
	db TCG_WATER,		TCG_FIGHTING,		SUPER_EFFECTIVE
	db TCG_WATER,		TCG_GRASS,			NOT_VERY_EFFECTIVE
	db TCG_WATER,		TCG_DRAGON,			NOT_VERY_EFFECTIVE

	db TCG_GRASS,		TCG_WATER,			SUPER_EFFECTIVE
	db TCG_GRASS,		TCG_FIGHTING,		SUPER_EFFECTIVE
	db TCG_GRASS,		TCG_DARK,			SUPER_EFFECTIVE
	db TCG_GRASS,		TCG_FIRE,			NOT_VERY_EFFECTIVE
	db TCG_GRASS,		TCG_METAL,			NOT_VERY_EFFECTIVE
	db TCG_GRASS,		TCG_DRAGON,			NOT_VERY_EFFECTIVE

	db TCG_LIGHTNING,	TCG_WATER,			SUPER_EFFECTIVE
	db TCG_LIGHTNING,	TCG_COLORLESS,		SUPER_EFFECTIVE
	db TCG_LIGHTNING,	TCG_FIGHTING,		NOT_VERY_EFFECTIVE
;	db TCG_LIGHTNING,	TCG_DRAGON,			NOT_VERY_EFFECTIVE ; ?

	db TCG_PSYCHIC,		TCG_GRASS,			SUPER_EFFECTIVE
	db TCG_PSYCHIC,		TCG_FIGHTING,		SUPER_EFFECTIVE
	db TCG_PSYCHIC,		TCG_PSYCHIC,		SUPER_EFFECTIVE
	db TCG_PSYCHIC,		TCG_METAL,			NOT_VERY_EFFECTIVE
	db TCG_PSYCHIC,		TCG_COLORLESS,		NOT_VERY_EFFECTIVE
	db TCG_PSYCHIC,		TCG_DARK,			NOT_VERY_EFFECTIVE
	db TCG_PSYCHIC,		TCG_DRAGON,			NOT_VERY_EFFECTIVE ; ?
	...
	db TCG_DRAGON,		TCG_DRAGON,			SUPER_EFFECTIVE

	db TCG_DARK,		TCG_PSYCHIC,		SUPER_EFFECTIVE

	db TCG_WATER2,		TCG_FIRE,			SUPER_EFFECTIVE
	db TCG_WATER2,		TCG_FIGHTING,		SUPER_EFFECTIVE
	db TCG_WATER2,		TCG_GRASS,			NOT_VERY_EFFECTIVE
	db TCG_WATER2,		TCG_DRAGON,			NOT_VERY_EFFECTIVE
	db TCG_WATER2,		TCG_WATER,			SUPER_EFFECTIVE ; for Freeze Dry

	db -1 ; end

; ========================================================================================================================================

TypeEffects_TCGInverse:
	;  attacker,     defender,     *=

	db TCG_FIGHTING,	TCG_LIGHTNING,		NOT_VERY_EFFECTIVE
	db TCG_FIGHTING,	TCG_COLORLESS,		NOT_VERY_EFFECTIVE
	db TCG_FIGHTING,	TCG_DARK,			NOT_VERY_EFFECTIVE
	db TCG_FIGHTING,	TCG_PSYCHIC,		SUPER_EFFECTIVE
	db TCG_FIGHTING,	TCG_DRAGON,			SUPER_EFFECTIVE

	db TCG_METAL,		TCG_WATER,			NOT_VERY_EFFECTIVE
	db TCG_METAL,		TCG_PSYCHIC,		NOT_VERY_EFFECTIVE ; ?
	db TCG_METAL,		TCG_LIGHTNING,		SUPER_EFFECTIVE

	db TCG_FIRE,		TCG_GRASS,			NOT_VERY_EFFECTIVE
	db TCG_FIRE,		TCG_METAL,			NOT_VERY_EFFECTIVE
	db TCG_FIRE,		TCG_WATER,			SUPER_EFFECTIVE ; ?
	db TCG_FIRE,		TCG_DRAGON,			SUPER_EFFECTIVE

	db TCG_WATER,		TCG_FIRE,			NOT_VERY_EFFECTIVE
	db TCG_WATER,		TCG_FIGHTING,		NOT_VERY_EFFECTIVE
	db TCG_WATER,		TCG_GRASS,			SUPER_EFFECTIVE
	db TCG_WATER,		TCG_DRAGON,			SUPER_EFFECTIVE

	db TCG_GRASS,		TCG_WATER,			NOT_VERY_EFFECTIVE
	db TCG_GRASS,		TCG_FIGHTING,		NOT_VERY_EFFECTIVE
	db TCG_GRASS,		TCG_DARK,			NOT_VERY_EFFECTIVE
	db TCG_GRASS,		TCG_FIRE,			SUPER_EFFECTIVE
	db TCG_GRASS,		TCG_METAL,			SUPER_EFFECTIVE
	db TCG_GRASS,		TCG_DRAGON,			SUPER_EFFECTIVE

	db TCG_LIGHTNING,	TCG_WATER,			NOT_VERY_EFFECTIVE
	db TCG_LIGHTNING,	TCG_COLORLESS,		NOT_VERY_EFFECTIVE
	db TCG_LIGHTNING,	TCG_FIGHTING,		SUPER_EFFECTIVE
;	db TCG_LIGHTNING,	TCG_DRAGON,			SUPER_EFFECTIVE ; ?

	db TCG_PSYCHIC,		TCG_GRASS,			NOT_VERY_EFFECTIVE
	db TCG_PSYCHIC,		TCG_FIGHTING,		NOT_VERY_EFFECTIVE
	db TCG_PSYCHIC,		TCG_PSYCHIC,		NOT_VERY_EFFECTIVE
	db TCG_PSYCHIC,		TCG_METAL,			SUPER_EFFECTIVE
	db TCG_PSYCHIC,		TCG_COLORLESS,		SUPER_EFFECTIVE
	db TCG_PSYCHIC,		TCG_DARK,			SUPER_EFFECTIVE
	db TCG_PSYCHIC,		TCG_DRAGON,			SUPER_EFFECTIVE ; ?
	...
	db TCG_DRAGON,		TCG_DRAGON,			NOT_VERY_EFFECTIVE

	db TCG_DARK,		TCG_PSYCHIC,		NOT_VERY_EFFECTIVE

	db TCG_WATER2,		TCG_FIRE,			NOT_VERY_EFFECTIVE
	db TCG_WATER2,		TCG_FIGHTING,		NOT_VERY_EFFECTIVE
	db TCG_WATER2,		TCG_GRASS,			SUPER_EFFECTIVE
	db TCG_WATER2,		TCG_DRAGON,			SUPER_EFFECTIVE
	db TCG_WATER2,		TCG_WATER,			SUPER_EFFECTIVE ; for Freeze Dry
