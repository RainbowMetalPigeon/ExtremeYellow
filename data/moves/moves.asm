...
;	move SHARPEN,      ATTACK_UP1_EFFECT,            0, NORMAL,       100, 30 ; - REMOVED - Porygon will get SWORDS_DANCE and AMNESIA instead :)
	...
	move PLAY_ROUGH,   ATTACK_DOWN_SIDE_EFFECT1,    90,	FAIRY,	       90, 10 ; done
	...
	move SUPERPOWER,   ATTACK_DEFENSE_SELFDOWN1,   120,	FIGHTING,	  100, 5  ; done
	move CLOSE_COMBAT, DEFENSE_SPECIAL_SELFDOWN1,  120,	FIGHTING,	  100, 5  ; [TM37] done
	...
	move SHADOW_BALL,  SPECIAL_DOWN_SIDE_EFFECT2,   80,	GHOST,	      100, 15 ; [TM49], done
	...
	move LEAF_STORM,   SPECIAL_SELFDOWN2,	   	   140, GRASS,         90, 5  ; done
	move ENERGY_BALL,  SPECIAL_DOWN_SIDE_EFFECT1,   90,	GRASS,        100, 10 ; done
	move FRENZY_PLANT, HYPER_BEAM_EFFECT,	       150,	GRASS,         90, 5  ; done

	move MUD_SLAP,	   ACCURACY_DOWN_SIDE_EFFECT_CERT,	20,	GROUND,   100, 10 ; done
	move MUD_SHOT,	   SPEED_DOWN_SIDE_EFFECT_CERT,	55,	GROUND,	       95, 15 ; done
	...
	move ROCK_TOMB,	   SPEED_DOWN_SIDE_EFFECT_CERT, 60,	ROCK,	       95, 15 ; done
	...
	move STEEL_WING,   DEFENSE_UP_SIDE_EFF1,	    70,	STEEL,	       90, 25 ; done - self-buff, 10% def
	move METAL_CLAW,   ATTACK_UP_SIDE_EFF1,	    	50,	STEEL,	       95, 35 ; done - self-buff, 10% atk
	move METEOR_MASH,  ATTACK_UP_SIDE_EFF2, 	   100,	STEEL,	       85, 10 ; done - self-buff, 20% atk [TM09]
	...
	move QUIVER_DANCE, SPECIAL_SPEED_UP1_EFFECT,     0,	BUG,	      100, 20 ; done
	move SYNTHESIS,    HEAL_EFFECT,					 0, GRASS,          0,  5 ; done
	move PERISH_SONG,  PERISH_SONG_EFFECT,			 0, NORMAL,         0,  5 ; done
