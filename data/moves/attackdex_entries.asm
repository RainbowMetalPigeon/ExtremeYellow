AttackdexEntryPointers:
	table_width 2, AttackdexEntryPointers
	...
	dw MapPieceDexEntry
	dw MapPieceDexEntry
	assert_table_length NUM_POKEMON_INDEXES ; NUM_ATTACKS
