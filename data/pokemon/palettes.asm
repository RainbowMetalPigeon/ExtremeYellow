...
MonsterPalettesShiny: ; temp, testing
	...
	db PAL_BLACKMON   ; MCHARZARDX
	db PAL_GREENMON    ; MCHARZARDY
	db PAL_GREENMON   ; SQUIRTLE
	db PAL_GREENMON   ; WARTORTLE
	db PAL_PURPLEMON   ; BLASTOISE, updated
	db PAL_PURPLEMON   ; MBLASTOISE, updated
	...
	db PAL_GREYMON ; RATTATA, updated
	db PAL_REDMON  ; RATICATE, updated
	...
	db PAL_REDMON   ; GOLDUCK, updated
	db PAL_GREENLIGHTMON  ; MANKEY
	db PAL_GREENMON  ; PRIMEAPE
	db PAL_BLUEMON   ; ANNIHILAPE, updated, testing
	db PAL_YELLOWMON    ; GROWLITHE, updated
	...
	db PAL_GREENMON   ; MACHOP, updated, testing
	db PAL_GREENMON   ; MACHOKE, updated, testing
	db PAL_GREENMON   ; MACHAMP, updated, testing
	...
	db PAL_YELLOWMON  ; GOLEM, updated
	...
	db PAL_REDMON ; SHELLDER, updated
	db PAL_BLUEMON ; CLOYSTER, updated
	db PAL_CYANMON ; GASTLY
	db PAL_PINKMON ; HAUNTER
	db PAL_BLACKMON ; GENGAR
	db PAL_GREYMON ; MGENGAR
	...
	db PAL_GREENMON  ; CUBONE, updated
	db PAL_GREENMON  ; MAROWAK, updated
	...
	db PAL_GREENMON  ; TAUROS, updated
	db PAL_YELLOWMON    ; MAGIKARP
	db PAL_REDMON   ; GYARADOS
	db PAL_REDMON   ; MGYARADOS
	db PAL_PURPLEMON   ; LAPRAS
	db PAL_CYANMON   ; DITTO, updated
	db PAL_GREYMON  ; EEVEE, updated
	db PAL_PURPLEMON   ; VAPOREON, updated
	...
	db PAL_PINKMON   ; DRATINI, updated
