...
; 3-island
	...
	dw SeviiBerryForestWildMons      ; SEVII_BERRY_FOREST
	dw SeviiRoute33DiveWildMons      ; SEVII_ROUTE_33_DIVE
...
; 5-island
	...
	dw SeviiFiveIslandWarehouseBFWildMons ; SEVII_FIVE_ISLAND_WAREHOUSE_BF
...
INCLUDE "data/wild/maps/sevii/SeviiSecretBeach.asm"
