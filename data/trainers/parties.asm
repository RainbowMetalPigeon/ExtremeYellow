...
SabrinaData:
	db 1, DITTO, 0 ; 1, proxy
	db $FF, 20, MIME_JR, 20, DROWZEE, 20, SMOOCHUM, 20, SLOWPOKE, 20, EXEGGCUTE, 21, KADABRA, 0 ; 2
	db $FF, 27, MR_MIME, 27, DROWZEE, 27, JYNX, 27, SLOWPOKE, 27, EXEGGCUTE, 28, KADABRA, 0 ; 3
	db $FF, 31, MR_MIME, 31, HYPNO, 31, ESPEON, 31, SLOWKING, 31, EXEGGUTOR, 32, ALAKAZAM, 0 ; 4
	db $FF, 42, SLOWKING, 42, HYPNO, 42, EXEGGUTOR, 42, ESPEON, 42, STARMIE, 43, ALAKAZAM, 0 ; 5
	db $FF, 49, MR_MIME, 49, SLOWBRO, 49, JYNX, 49, ESPEON, 49, EXEGGUTOR, 50, ALAKAZAM, 0 ; 6
	db $FF, 53, MR_MIME, 53, SLOWBRO, 53, JYNX, 53, ESPEON, 53, EXEGGUTOR, 54, ALAKAZAM, 0 ; 7
	db $FF, 54, JYNX, 54, ESPEON, 54, SLOWBRO, 54, EXEGGUTOR, 54, STARMIE, 55, ALAKAZAM, 0 ; 8
