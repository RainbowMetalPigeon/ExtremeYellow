...
LoreleiData:
	db 1, DEWGONG, 0; CLOYSTER, JYNX, GLACEON, LAPRAS, MSLOWBRO, 0 ; updated
	db 3, JYNX, 0; DEWGONG, CLOYSTER, GLACEON, LAPRAS, MSLOWBRO, 0 ; rematch

BrunoData:
	db 1, HITMONTOP, 0; HITMONCHAN, HITMONLEE, POLIWRATH, MACHAMP, MSTEELIX, 0 ; updated
	db 3, HITMONLEE, 0; POLIWRATH, HITMONTOP, ANNIHILAPE, MACHAMP, MSTEELIX, 0 ; rematch

AgathaData:
	db 1, GENGAR, 0; CROBAT, GENGAR, ANNIHILAPE, UMBREON, MGENGAR, 0 ; updated
	db 3, GENGAR, 0; ANNIHILAPE, CROBAT, GENGAR, UMBREON, MGENGAR, 0 ; rematch

LanceData:
	db 1, GYARADOS, 0; DRAGONITE, AERODACTYL, KINGDRA, DRAGONITE, MCHARZARDX, 0 ; updated
	db 3, AERODACTYL, 0; DRAGONITE, GYARADOS, KINGDRA, DRAGONITE, MCHARZARDX, 0 ; rematch
...
Rival3Data:
	db 1, MPIDGEOT, 0; MALAKAZAM, MSCIZOR, MVENUSAUR, MCHARZARDY, MBLASTOISE, 0 ; updated
	db 1, ARTICUNO, 0; ZAPDOS, MOLTRES, 0 ; new
	; teams for League Rematch (pre rematch gym leaders)
	db 2, MPIDGEOT, 0; MALAKAZAM, MVENUSAUR, MCHARZARDY, MBLASTOISE, UMBREON, 0 ; updated
	db 2, ARTICUNO, 0; ZAPDOS, MOLTRES, 0 ; new - redundant because the same as the first rematch, but like this the structure is more uniform
	; teams for League Rematch (post rematch gym leaders)
	db 3, MPINSIR, 0; MPIDGEOT, MALAKAZAM, MVENUSAUR, MCHARZARDY, MBLASTOISE, 0
	db $FF, 3, ARTICUNO, 0; 83, ZAPDOS, 83, MOLTRES, 84, MEWTWO, 84, MEW, 85, UMBREON, 0
