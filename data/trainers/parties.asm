...
;	db $FF, 50, DUGTRIO, 53, PERSIAN, 53, NIDOQUEEN, 55, NIDOKING, 55, RHYDON, 0
	db $FF, 54, DUGTRIO, 54, GOLEM, 54, NIDOQUEEN, 54, NIDOKING, 54, PERSIAN, 55, RHYPERIOR, 0 ; updated
...
;	db $FF, 53, ONIX, 55, HITMONCHAN, 55, HITMONLEE, 56, ONIX, 58, MACHAMP, 0
	db $FF, 58, HITMONTOP, 58, HITMONCHAN, 55, HITMONLEE, 58, POLIWRATH, 58, MACHAMP, 58, MSTEELIX, 0 ; updated
...
;	db $FF, 30, TANGELA, 32, WEEPINBELL, 32, GLOOM, 0
	db $FF, 31, VICTREEBEL, 31, VILEPLUME, 31, BELLOSSOM, 31, PARASECT, 31, LEAFEON, 31, TANGROWTH, 0 ; updated
...
;	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 0
	db $FF, 56, DEWGONG, 56, CLOYSTER, 56, JYNX, 56, GLACEON, 56, LAPRAS, 56, MSLOWBRO, 0 ; updated
...
;	db $FF, 56, GENGAR, 56, GOLBAT, 55, HAUNTER, 58, ARBOK, 60, GENGAR, 0
	db $FF, 60, GENGAR, 60, CROBAT, 60, GENGAR, 60, ANNIHILAPE, 60, UMBREON, 60, MGENGAR, 0 ; updated

LanceData:
;	db $FF, 58, GYARADOS, 56, DRAGONAIR, 56, DRAGONAIR, 60, AERODACTYL, 62, DRAGONITE, 0
	db $FF, 62, GYARADOS, 62, DRAGONITE, 62, AERODACTYL, 62, KINGDRA, 62, DRAGONITE, 62, MCHARZARDX, 0 ; updated
