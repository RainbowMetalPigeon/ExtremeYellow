...
Rival3Data:
	...
	db 65, MPIDGEOT, MALAKAZAM, MVENUSAUR, MCHARZARDY, MBLASTOISE, UMBREON, 0 ; updated
	db 70, ARTICUNO, ZAPDOS, MOLTRES, 0 ; new - redundant because the same as the first rematch, but like this the structure is more uniform
