...
; Silph Co. 7F (7)
	db 42, ANNIHILAPE, ELECTIVIRE, JYNX, MAGMORTAR, SNORLAX, UMBREON, 0 ; updated
; Route 22 (10)
	db 58, JOLTEON, VAPOREON, FLAREON, LEAFEON, GLACEON, UMBREON, 0 ; updated
; NEW
; Snorlaxs (6)
	db 34, AERODACTYL, STARMIE, TANGROWTH, MAGNEZONE, GYARADOS, UMBREON, 0 ; TBE
; Mt Moon Extension (8)
	db 47, ALAKAZAM, BLISSEY, RHYPERIOR, KINGDRA, EXEGGUTOR, UMBREON, 0 ; TBE
; Pokemon Mansion (9)
	db 53, LAPRAS, STEELIX, GENGAR, DRAGONITE, TAUROS, UMBREON, 0 ; TBE
