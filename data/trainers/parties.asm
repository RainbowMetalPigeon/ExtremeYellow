...
; NEW
; Snorlaxs (6)
	db 34, AERODACTYL, STARMIE, TANGROWTH, MAGNEZONE, GYARADOS, UMBREON, 0 ; index 5
; Mt Moon Extension (8)
	db 47, ALAKAZAM, BLISSEY, RHYPERIOR, KINGDRA, EXEGGUTOR, UMBREON, 0 ; index 6
; Pokemon Mansion (9)
	db 53, LAPRAS, STEELIX, GENGAR, DRAGONITE, TAUROS, UMBREON, 0 ; index 7
