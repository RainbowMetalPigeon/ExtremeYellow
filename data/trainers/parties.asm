...
; Lunar Shrine, Rocket siblings ambush
	db 45, PARASECT, 0;VENOMOTH, ARBOK, CLOYSTER, WEEZING, 0 ; $37=55
	db 45, DUGTRIO, 0;PERSIAN, CROBAT, ALAKAZAM, TAUROS, 0 ; $38=56
	db 45, ELECTRODE, 0;WEEZING, GOLEM, CLOYSTER, LICKILICKY, 0 ; $39=57
	db 45, MUK, 0;VILEPLUME, BLISSEY, STEELIX, UMBREON, 0 ; $3A=58
...
; Pokemon Mansion (9)
	db 53, LAPRAS, 0;MACHAMP, GENGAR, DRAGONITE, GYARADOS, UMBREON, 0 ; index 7
