...
LoreleiData:
	db 1, DEWGONG, 0; CLOYSTER, JYNX, GLACEON, LAPRAS, MSLOWBRO, 0 ; updated ; 56
	db 3, JYNX, 0; DEWGONG, CLOYSTER, GLACEON, LAPRAS, MSLOWBRO, 0 ; rematch ; 75

BrunoData:
	db 1, HITMONTOP, 0; HITMONCHAN, HITMONLEE, POLIWRATH, MACHAMP, MSTEELIX, 0 ; updated ; 58
	db 3, HITMONLEE, 0; POLIWRATH, HITMONTOP, ANNIHILAPE, MACHAMP, MSTEELIX, 0 ; rematch ; 75

AgathaData:
	db 1, GENGAR, 0; CROBAT, GENGAR, ANNIHILAPE, UMBREON, MGENGAR, 0 ; updated ; 60
	db 3, GENGAR, 0; ANNIHILAPE, CROBAT, GENGAR, UMBREON, MGENGAR, 0 ; rematch ; 75

LanceData:
	db 1, GYARADOS, 0; DRAGONITE, AERODACTYL, KINGDRA, DRAGONITE, MCHARZARDX, 0 ; updated ; 62
	db 3, AERODACTYL, 0; DRAGONITE, GYARADOS, KINGDRA, DRAGONITE, MCHARZARDX, 0 ; rematch ; 75
...
Rival3Data:
	db 1, MPIDGEOT, 0; MALAKAZAM, MSCIZOR, MVENUSAUR, MCHARZARDY, MBLASTOISE, 0 ; 65
...
TravelerData:
	db 1, ZYGARDEC, UNECROZMA, MRAYQUAZA, EETERNATUS, ARCEUS, 0 ; new
	db 1, ZYGARDEC, UNECROZMA, MRAYQUAZA, EETERNATUS, ARCEUS, MMEWTWOX, 0 ; rematch
