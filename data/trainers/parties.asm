...
;	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, CHARIZARD, 70, GYARADOS, 0
	db $FF, 82, TAUROS, 82, MGYARADOS, 82, MEWTWO, 82, MMEWTWOX, 82, MMEWTWOY, 82, VENUSTOISE, 0 ; updated
...
;	db $FF, 37, NIDORINO, 35, PERSIAN, 37, RHYHORN, 41, NIDOQUEEN, 0
	db $FF, 42, STEELIX, 42, NIDOKING, 42, RHYDON, 42, NIDOQUEEN, 42, GOLEM, 42, PERSIAN, 0 ; updated
; Viridian Gym
...
;	db $FF, 25, FEAROW, 23, VULPIX, 22, MAGNEMITE, 20, SANDSHREW, 25, EEVEE, 0
	db 27, PINSIR, PORYGONZ, SCIZOR, CLOYSTER, NINETALES, UMBREON, 0 ; updated
; Silph Co. 7F
...
;	db $FF, 61, SANDSLASH, 59, ALAKAZAM, 61, EXEGGUTOR, 61, NINETALES, 63, MAGNETON, 65, VAPOREON, 0
	db $FF, 65, MPIDGEOT, 65, MALAKAZAM, 65, MSCIZOR, 65, MVENUSAUR, 65, MCHARZARDY, 65, MBLASTOISE, 0 ; updated
