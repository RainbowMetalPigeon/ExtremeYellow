...
PalPacket_Titlescreen:    PAL_SET PAL_LOGO2, PAL_EXTREME2, PAL_MEWMON, PAL_EXTREME1 ; edited, 1st PAL_LOGO1, was 3rd was PAL_PURPLEMON
...
PalPacket_TypeChart:      PAL_SET PAL_TYPE_CHART, 0, 0, 0 ; new
...
PalPacket_TrainerCardRed:    PAL_SET PAL_PLAYER_RED,    PAL_BLUEMON, PAL_REDMON, PAL_GREENMON
PalPacket_TrainerCardGreen:  PAL_SET PAL_PLAYER_GREEN,  PAL_BLUEMON, PAL_REDMON, PAL_GREENMON
PalPacket_TrainerCardYellow: PAL_SET PAL_PLAYER_YELLOW, PAL_BLUEMON, PAL_REDMON, PAL_GREENMON
